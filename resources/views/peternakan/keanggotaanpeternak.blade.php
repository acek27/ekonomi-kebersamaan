...
@section('isi')
    ...
    <input type="text" class="form-control form-control-user" id="jumlah" name="jumlah" aria-describedby="emailHelp" placeholder="">
    ...
    <input type="text" class="form-control form-control-user" id="idpeternak" name="idpeternak" aria-describedby="emailHelp" placeholder="" hidden >
<br>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table style="text-align: center" id="datapokter" class="table table-bordered table-striped table-hover">
                <thead>
                    <tr>
